...
export default function Home() {
  return (
    <div className="bg-white flex">
      <SideBar />
      <div className="ml-52 w-full min-h-screen p-6">
        ...
        <div className="flex space-x-10 mt-16">
          ...
          <div className="flex-1">
            ...
            <ul className="list-none pl-5 space-y-2 text-gray-700">
              ...
              <li className="flex items-start">
                <span className="mr-2 font-semibold">Number of Platforms:</span> The count of platforms on which a game is available.
              </li>
              <li className="flex items-start">
