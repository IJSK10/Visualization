    ...
    return (
        <div className="fixed left-0 top-0 h-full w-40 bg-gray-800 flex flex-col items-center rounded-r-lg overflow-y-auto" >
            ...
            <div className="flex flex-col justify-center items-center h-full gap-4 p-4">
                <button className="p-2 bg-blue-400 text-white w-36 rounded-full hover:bg-blue-700 transition flex flex-col items-center gap-2" onClick={() => router.push('/one')}>
                ...
                <button className="p-2 bg-blue-400 text-white w-36 rounded-full hover:bg-blue-700 transition" onClick={() => router.push('/two')}>
                <div className="flex flex-row">
